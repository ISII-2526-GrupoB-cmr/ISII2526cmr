...
VALUES (1, N'Sedan', N'Gris', N'Sedán cómodo y eficiente, ideal para ciudad.', N'1.8L', N'Gasoline', N'Regular', N'Toyota', 101, 2300000, 0, 0, 85, 16, 1);
...
INSERT INTO [dbo].[Purchases] ([Id], [ApplicationUserId], [DeliveryCarDealer],  [PurchasingDate],[PaymentMethod], [PurchasingPrice], [DeliveryAddress])
VALUES (1, 1, N'Concesionario Madrid Centro', '2025-06-01',1 , 2300000, N'Calle Falsa 1');

INSERT INTO [dbo].[Purchases] ([Id], [ApplicationUserId], [DeliveryCarDealer],[PurchasingDate], [PaymentMethod] , [PurchasingPrice], [DeliveryAddress])
VALUES (2, 2, N'AutoPlanet Barcelona',  '2025-07-15',2, 2950000, N'Calle Falsa 2');

INSERT INTO [dbo].[Purchases] ([Id], [ApplicationUserId], [DeliveryCarDealer], [PurchasingDate], [PaymentMethod], [PurchasingPrice], [DeliveryAddress])
VALUES (3, 3, N'BMW Premium Valencia', '2025-08-10',1 , 6870000, N'Calle Falsa 3');
